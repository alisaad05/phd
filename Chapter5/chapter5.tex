...
All mass and volume data related to both air and metal are plotted in \cref{fig:global_smacs_metal}. 
...
It can be explained by the new quantities of solute that adds up incrementally to the system after each species resolution. 
