...
We cannot much of differences when comparing mass analysis for all three techniques, as shown by the dotted lines in \cref{fig:mass_species}.
...
\end{tikzpicture}
%-------
\caption{Mass variation plots for the metal and its chemical species, considering three different strategies 
to account for the species conservation in the air domain.}
