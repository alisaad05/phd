...
forms near the contact surface. The abrupt phase change imposes a fast shrinkage rate, which tend to straighten the interface near the substrate, as also visible in \cref{fig:bin_vs_exp}. 
A part of the flow thus deviates towards the solid front 
to compensate for the density increase, as shown in \cref{eq:darcy_modif}. 
...
{1.0}
%path 
{Chapter5/Graphics/3d/bin/inverse_seg.pdf}
% caption
{Flow deviation towards the solidification front, contributing in solute transport in its direction.}
% label
\label{fig:texus_inverse_seg}
\end{figureth}
%--------------

This flow contributes to a slight enrichment at the contact surface.
The BCC phase fraction is soon decreased by the peritectic reaction to form the first FCC phase at about 0.75 s. 
...
% caption
{Evolution of the average composition versus time.}
% label
