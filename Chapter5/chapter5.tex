...
in a single time step, $g^E$ being the volume fraction of eutectic. The velocity increase causes species transport in the opposite direction of solidification,
...
the composition solution. The second comment is about the intensity of the instability (even if in a smaller thickness), which is still better than the first result (\cref{fig:1dalsi7_wVSlength}a) 
...
\caption{Plot of the average composition as function of length, along a vertical line passing through the centre of the sample at 1000 s, with 
		(a) monolithic strategy with low solute diffusion in the air and unmodified solute advection (minimum composition reaches \SI{2.2}{\ucomposition} Si but not shown), 
		(b) monolithic strategy with low solute diffusion and advection and (c) a non monolithic strategy
		for species conservation resolution. 
