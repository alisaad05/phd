...
\Cref{fig:mass_species} shows the relative mass variation of the metal and the silicon species
...
However, the latter may also be lost or gained depending on the way the configuration of the simulation, 
how it is solved, the boundary conditions ...
...
Minor differences are detected in the when comparing these three techniques, as shown by the dotted lines in \cref{fig:mass_species}.
...
\end{tikzpicture}
%-------
\caption{Mass variation plots for the metal and the chemical species the latter contains, considering three different strategies 
to account for the species conservatio in the air.}
\label{fig:mass_species}
\end{figure}
%--------------------------------------
\shorthandon{;:?!} %http://tex.stackexchange.com/questions/74860/unexpected-clash-between-babel-and-pgf-spy
