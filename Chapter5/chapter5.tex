...
\caption{Final macrosegregation pattern showing the positively segregated channels within negative segregation areas to the right,
while on the left the last liquid to solidify forms a recognisable pipe shrinkage and a positively segregated region underneath it.} 
\label{fig:smacs_final}
\end{figure}
%------------------
...
All mass and volume data are plotted in \cref{fig:global_smacs_metal}. The main reason for grouping all plots in a single
