...
vector. When using the level set method, it is possible to compute the fluid velocity in the viciniy of the interface, no longer needing 
any imposed velocity in this region. However, we need to understand the effect of chaning the upper boundary condition on the fluid flow, hence
on macrosegregation. Therefore, we replace no-slip condition on the top boundary by an imposed zero normal velocity but having a free-slip tangential component. 
...
\centering
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
  \includegraphics[height=4cm]{Chapter5/Graphics/2d/ref_2800s_nosliptop.png}
  \caption{}
    \label{fig:noslip}
  \end{subfigure}
  %------------------------------
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
  \includegraphics[height=4cm]{Chapter5/Graphics/2d/ref_2800s_sliptop_wcolorbar.png}
  \caption{}
    \label{fig:freeslip}
  \end{subfigure}
   %------------
...
\centering
  ...
  \begin{subfigure}[t]{0.35\textwidth}
    \centering
  \includegraphics[height=4cm]{Chapter5/Graphics/2d/ref_7000s_nosliptop.png}
  \caption{}
    \label{fig:noslip}
  \end{subfigure}
  %------------------------------
  ...
  \begin{subfigure}[t]{0.1\textwidth}
    \centering
  \includegraphics[height=4cm]{Chapter5/Graphics/2d/colorbar.pdf}
  \end{subfigure}
  %-----------
  %------------------------------
  \begin{subfigure}[t]{0.35\textwidth}
    \centering
  \includegraphics[height=4cm]{Chapter5/Graphics/2d/ref_7000s_sliptop.png}
  \caption{}
    \label{fig:freeslip}
  \end{subfigure}
   %------------
