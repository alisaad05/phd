...
%-------------------
 \begin{axis}
  [	name=whatever,
	...
	\addplot table [x expr=\thisrow{arc_length}*1000, y expr=100*(\thisrow{Concentration_M}-0.105)/0.105] {Chapter5/Data/3d_segregation/BinTransformationPath.txt};
  ...
  [	name=whatever,
	...
	\addplot table [x expr=\thisrow{arc_length}*1000, y=FractionBCC_c] {Chapter5/Data/3d_segregation/BinTransformationPath.txt};
	\addplot table [x expr=\thisrow{arc_length}*1000, y=FractionFCC_c] {Chapter5/Data/3d_segregation/BinTransformationPath.txt};
	\addplot table [x expr=\thisrow{arc_length}*1000, y=FractionCEM_c] {Chapter5/Data/3d_segregation/BinTransformationPath.txt};
	%\draw[thick, dashed, black, opacity=0.5] (axis cs:\pgfkeysvalueof{/pgfplots/xmin},0.0) -- (axis cs:\pgfkeysvalueof{/pgfplots/xmax},0.0);
	\legend{BCC,FCC,CEM}
  	\end{axis}
\end{tikzpicture}
...
% caption
{Comparison of final droplet profiles obtained by solidifying \emph{b1Bin}, \emph{b1Tern} and \emph{b1Quat} samples, with respect to the initial profile. The \emph{b1BinCoarse} sample
...
but with a mapping of 0.047 wt\% instead of 0.0042 wt\% used for the \emph{b1Bin} sample.
...
\end{tikzpicture}
%-------
\caption{Mesosegregation profiles as functions of the distance from the chill, plotted for (a) carbon (b) silicon and (c) manganese elements
