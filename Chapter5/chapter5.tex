...
\addplot table [x=Temps, y expr=100*(\thisrow{mM}-0.00022585082)/0.00022585082] {Chapter4/Data/3d_parametric/H1G0.txt};
\addplot table [x=Temps, y expr=100*(\thisrow{mM}-0.00022585082)/0.00022585082] {Chapter4/Data/3d_parametric/H2G0.txt};
\addplot table [x=Temps, y expr=100*(\thisrow{mM}-0.00022585082)/0.00022585082] {Chapter4/Data/3d_parametric/H3G0.txt};
\addplot table [x=Temps, y expr=100*(\thisrow{mM}-0.00022585082)/0.00022585082] {Chapter4/Data/3d_parametric/H4G0.txt};

\legend{H1G0,H2G0,H3G0,H4G0}
\end{axis}
\end{tikzpicture}
\caption{Mass conservation analysis for cases HxG0 (x=1,2,3,4).}
...
{0.95}
%path 
{Chapter4/Graphics/3d/parametricH.pdf}
% caption
...
{0.95}
%path 
{Chapter4/Graphics/3d/parametricG.pdf}
% caption
...
\subsubsection{Mesh influence}
Adaptive iso versus adaptive aniso on mass conservation
