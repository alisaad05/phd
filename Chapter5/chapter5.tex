...
\Cref{fig:1d_alsi7_geobc} shows the geometry, mesh used for this section simulations. In the same figure, the thermal and mechanical boundary conditions are shown.
...
\comment{PARAGRAPH MOVED TO INTRODUCTION, MAKE NECESSARY CORRECTIONS}
