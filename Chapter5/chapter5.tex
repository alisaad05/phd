...
composition value, $\mix{\avg{w}}$, in a straightforward manner at each time increment:  
% -----------
\begin{align}
...
as dictates the previous monolithic strategy, while air density remains constant in this work.
