...
but with a mapping of 0.047 wt\% instead of 0.0042 wt\% used for the \emph{b1Bin} sample. The corresponding profile in \cref{fig:shape_comparison}, \emph{b1Coarse},
shows a different deformation then expected by the other samples.
