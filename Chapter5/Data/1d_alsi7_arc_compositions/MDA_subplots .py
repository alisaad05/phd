...
delim= ','
z1 = np.genfromtxt('MDA_200s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns)
z3 = np.genfromtxt('MDA_600s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns )
z5 = np.genfromtxt('MDA_800s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True , usecols=input_columns )
...
#plt.show()
plt.savefig('MDA_subplots.png', dpi=300, bbox_inches='tight')
plt.savefig('MDA_subplots.pdf', bbox_inches='tight')