...
mFreq = 20000 #Mark plot every x number of points
marker = itertools.cycle(('^','x', 'o', 'p', 'v','d','>','+'))  #randomize marker style
foldername = 'no_macro_no_shrinkage'
z1 = np.genfromtxt(foldername+'\CapteurP1_1.xls', delimiter='\t', skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
z2 = np.genfromtxt(foldername+'\CapteurP1_2.xls', delimiter='\t', skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
z3 = np.genfromtxt(foldername+'\CapteurP1_3.xls', delimiter='\t', skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
z4 = np.genfromtxt(foldername+'\CapteurP1_4.xls', delimiter='\t', skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
...
ax.plot(z1['Temps'], z1['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z2['Temps'], z2['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z3['Temps'], z3['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z4['Temps'], z4['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z5['Temps'], z5['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z6['Temps'], z6['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z7['Temps'], z7['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
ax.plot(z8['Temps'], z8['TemperatureC'], marker = marker.next(), color=c2, markersize=mSize, markevery=mFreq, alpha=mTransp, lw=lw , ls=ls)
...
# plt.show()
plt.savefig('shrinkage_effect_ppt.png', dpi=200, bbox_inches='tight')
plt.savefig('shrinkage_effect_ppt.pdf', bbox_inches='tight',bbox_extra_artists=(lgd,))