...
\caption{Plot of the average composition as function of length, along a vertical line passing through the center of the sample at 1000 s, with 
		(a) low solute solute diffusion in the air but unmodified solute advection (minimum composition \bin{}{2.2}{Si} not shown), 
...
The TEMPUS experiment came as a first alternative for EML experiments. During several cycles of free fall, a reduced-gravity condition
is created allowing to use only a single RF coil to stabilise the position of the droplet, while the substrate comes into contact with the molten sample
from above it. An axial pyrometer

\subsubsection{TEXUS sounding rocket}
TEXUS-46 is the name of the sounding rocket that carries the experimental setup, 
