...
%scenario. 
The second term in the RHS of \cref{eq:energy_balance} is a heat power (of unit $Wm^{-3}$) that adds 
to the system in the mushy zone. This term is proportional to the solidification rate and expresses 
the heat generated in regions where the average density is changing and/or a gradient of liquid density is advected.
% ======================
...
average composition $\avg{w}^M$ for the metal. The splitting is done as follows:
\begin{align}
