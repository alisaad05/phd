...
in the X and Y directions, as shown in \cref{fig:imagetomesh}.
...
{1.0}
%path 
{Chapter4/Graphics/3d/imagetomesh.pdf}
% caption
...
and an effective exchange coefficient $\hext$ of \SI{6e4}{\uhconvec}. The $\hext$ coefficient's value has been determined by running multiple simulations with different values in the aim
...
\addplot table [x=time, y=position] {Chapter4/Data/3d/newdroplet_h6e4.txt};
...
\legend{Old Simulation, New $\hext=6e^4$, TEXUS, TEMPUS}
\end{axis}
\end{tikzpicture}
