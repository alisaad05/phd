...
\addplot table [x=Temps, y=mMpct] {Chapter4/Data/1d_alsi7_mass/ArtificialDarcyBlocking0pct.txt} \closedcycle ;
...
This is no surprise about how poor is mass conservation with the level set method. However, the mass variation
that we see in the previous plots is more related to a physical problem: \textbf{at which velocity does the interface move?}
In our simulations, we systemtically considered the Navier-Stokes solution $\vitf$, which is $\vit= \gl \vl$ in the metal subdomain.
