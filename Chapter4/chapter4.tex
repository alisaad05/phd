...
speed close to \SI{0.7}{\milli \uvelocity}, was obtained by setting simultaneously $\hext$=\SI{6e4}{\uhconvec} and $\norm{\gravity}$=\num{5e-5} \si{\uacceleration}.
To demonstrate the effect of varying these parameters, we present a parametric study in \cref{table:parametric_study}, where only the most relevant cases are studied.
