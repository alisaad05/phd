...
The energy balance in the governs the air enthalpy $\avg{\rho h}^A$ (which is equal to $\rhoa \ha$ 
...
known that suppressing the diffusion term in the air would result in a numerically stiff partial differential equation.
%--------------
\begin{align}
