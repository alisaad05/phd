...
should be fulfilled. It states that the formulation is ill-posed if both spaces have the same interpolation 
...
on all external sides of the cylinder. It is reminded also that the results of this application case has been published in \citep{saad_temperature-based_2015}.
...
Segregation becomes more negative up to 1 cm from the chill, corresponding 
...
composition and temperature distribution, while the right columns show the phase fractions \citep{saad_temperature-based_2015}.}
...
morphology would consider a channel with a diameter proportional to few primary dendrite arm spacings and a length that 
could vary from millimeters to centimeters. These “worm”-like shapes may form during directional solidification of cast 
parts designed for engine applications, particularly in nickel-base superalloys \citep{giamei_nature_1970,schneider_modeling_1997,beckermann_development_2000,
genereux_characterization_2000}. In the latter situation, the channels are often filled with a chain of small equiaxed 
