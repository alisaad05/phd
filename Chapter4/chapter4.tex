...
Prandtl ($Pr$) numbers expressing respectively the ratio of local permeability to a characteristic length $L$ and the ratio of
...
found to be almost superimposed. This is confirmed by a comparison made between both solvers, as shows \cref{fig:planche_HvsT}, 
where the average
...
if we compare the composition, we notice that the solidified part on the RHE side has basically the same segregation pattern, while
the convected liquid has a slightly different solute distribution. As for the extent of the mushy zone, we observe that liquid
...
The segregated channels inside the cylinder and on the boundary, are often termed \emph{freckles} 
when they consist of visible equiaxed grains \citep{copley_origin_1970}.
...
\centering
  ...
  \begin{subfigure}[t]{0.6\textwidth}
    \centering
	\includegraphics[width=\textwidth]{Chapter4/Graphics/multicomponent/transformationpath/TP_nomacro.pdf}
	\caption{}
  ...
  \begin{subfigure}[t]{0.6\textwidth}
    \centering
	\includegraphics[width=\textwidth]{Chapter4/Graphics/multicomponent/transformationpath/TP_macro.pdf}
	\caption{}
...
\centering
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
	\includegraphics[height=3.5cm]{Chapter4/Graphics/freckle_exp/setup.pdf}
	\caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
	\includegraphics[height=4cm]{Chapter4/Graphics/freckle_exp/img.png}
	\caption{}
...
\centering
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
	\includegraphics[width=\textwidth]{Chapter4/Graphics/freckle_fe/refA_new_annotate.png}
	\caption{FE-G1R1L0}
    \label{fig:refA}
  \end{subfigure}
   %------------------------------
