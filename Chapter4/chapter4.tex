...
The shrinkage phenomenon is manifested in 2 important locations, as depicted in \autoref{fig:real_ingot_stages}. 
...
% \end{subfigure}
% 
% \caption{Schematic of three cooling stages of an ingot against side and bottom mould walls (not shown). The top surface is free}
% \end{figure}
