...
\subsubsection{Geometry and initial mesh}
...
The steel sample is not perfectly spherical initially. The droplet hence is compared to an ellipsoid having
a vertical minor axis of \SI{5.68}{\milli \metre} and a horizontal major axis of \SI{6.6}{\milli \metre} 
in the X and Y directions.
The bottom is a planar surface (diameter of \SI{1}{\centi \metre}, where the contact is initiated). 
The alloy is immersed in a gas medium (argon), such that both subdomains form together 1/4 of a 
cylinder having \SI{8}{\milli \metre} in radius and  \SI{8}{\milli \metre} in height.

\subsubsection{Initial and boundary conditions}
The thermal boundary conditions are set as follows: Heat loss by radiation is experimentally avoided, therefore it is not considered in our model, hence all boundaries are considered adiabatic, except for the metal-substrate contact area,
as previously mentioned. This surface is modelled by a Fourier condition with $\Text$=\SI{25}{\udegC} and an effective exchange coefficient $\hext$ of \SI{2500}{\uhconvec}. The $\hext$ coefficient's value has been determined by running multiple simulations with different values in the aim
...
which may spuriously alter its final shape.
The pressure condition is left free for all boundaries, as the experiment does not provide any pressure measurement 
