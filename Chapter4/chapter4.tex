...
The integrals terms in \cref{eq:weakform_after} are interpolated at predefined integration points.
...
coefficient, $\hext$, and a constant environment temperature, $\Text$, as shown in \cref{fig:freckle_simu_bc}. On the same figure, 
