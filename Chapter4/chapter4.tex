...
in the metal's energy balance.
These quantities are defined in the following equations:
%------------
\begin{align}
%
...
also termed as \emph{solidification shrinkage} by \citet{flemings_macrosegregation:_1967}. In the current conditions, $\beta=$\SI{7.14}{\percent}.
%--------------------------------------
\begin{figure}[htbp]
\centering
\begin{tikzpicture}
...
\caption{Unique solidification path at nominal composition for the shrinkage without macrosegregation case.}
...
%--
\subsection{3D applicataion: TEXUS steel}
