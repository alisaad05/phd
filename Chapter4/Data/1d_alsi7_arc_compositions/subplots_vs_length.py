...
def plot_velocities_at_position(axis,data):
    vx , vy , gl, gs = data["Vitesse0"], data["Vitesse1"], data["FractionLiq_c"], data["FractionSolide_c"]
...
input_columns = ("Concentration","ConcentrationSolide","ConcentrationLiquide","arc_length","FractionSolide_c","FractionLiq_c", "DensityP1", "Vitesse0", "Vitesse1")     

delim= ','
z1 = np.genfromtxt('200s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns)
#z2 = np.genfromtxt('400s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns )
z3 = np.genfromtxt('600s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns )
#z4 = np.genfromtxt('800s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True ,  usecols=input_columns )
z5 = np.genfromtxt('800s.csv', delimiter=delim, skip_header=0, skip_footer=0, names=True , usecols=input_columns )
...
plt.savefig('compositions_vs_length.pdf', bbox_inches='tight')