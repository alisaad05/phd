...
as it allows local mesh refinement around the mobile interface over time, as well as regions 
undergoing solidification. These regions are indeed important to track as microsegregation 
starts in the mushy zone, i.e. between the liquidus and solidus temperatures given by a local solute
...
done at CEMEF. These techniques rely on metric tensors, and belong to
...
It is a metric construction method based on ISMetriqueMDS
