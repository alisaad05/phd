...
%------------
Now that the main conservation equations ingredients are properly defined, we may write each averged conservation
equation starting with the mass balance:
%------
\begin{align}
