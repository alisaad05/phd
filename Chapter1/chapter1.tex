...
Other types of segregation patterns can be encountered while casting heavy ingots, as schematised in \cref{fig:ingot_casting}: 
\begin{itemize}
\itemsep0em 
...
sodium chloride %\citep{wanqi_formation_1989,sarazin_studies_1992,ludwig_advanced_2012}.
%--------------------------------------------------------
%
%
%\subsection{Causes}
