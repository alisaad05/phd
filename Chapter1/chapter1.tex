...
depend upon this function, which will be discussed later in section \cref{sec:mixinglaws}.
...
When the transport equation in \cref{eq:transport_strong} is discretized in time then solved, a \emph{regularisation} 
