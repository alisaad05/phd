...
The position vector, denoted $\vec{x}$, is hence updated as follows:
%------
\begin{align}
\label{eq:lagrangian}
...
\comment{Talk about properties that can be readily obtained from the level set \citet{peng_pde-based_1999}
 normal vector
 curvature
 interface
 volume
