...
position, denoted $x$, is hence updated as follows:
%------
\begin{align}
\label{eq:lagrangian}
...
using a level set in a more meaningful way, but do not discuss the diffuse interface aspect. 

\comment{add two sentence about dirac and curvature, as properties that can be readily obtained from the level set}
