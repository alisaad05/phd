...
Say that henceforth the eulerian framework will be the interst of this study because we have mainly a fluid and a non deformable solid, which justifies the choice
...
\subsection{Microsegregtion model}
