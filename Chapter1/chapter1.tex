...
Other features can be deduced HERRRRE
...
% caption
{Schematic of two level properties inside the diffuse interface: Heavisde and Dirac delta functions.
...
An interface between two fluids may constantly move, consequently the level set transport allows
