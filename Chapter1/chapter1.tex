...
% caption
{Time evolution of a solidifying \bin{Al}{4}{Cu} sample, showing interface destabilisation 
and subsequent dendritic solidification \citep{buffet_measurement_2010}.
The liquid far from the interface and having a blue color is at nominal composition, 
while the one near the dendritic structure with the yellow and red colors, is richer in solute.}
% label
...
the fluid velocity $\vec{v}$ (assuming the solid phase is fixed), 
...
The latter parameter has been the subject of numerous studies that aimed
...
temperature range (BTR), where the solid fraction is typically greater than \num{90}\%.
%\begin{figureth}
