...
task while they yield different advantages and disadvantages. Such methods fall under two main categories, either interface tracking
...
The interested reader may refer to a quick reference by \citet{maitre_review_2006} about these methods.
...
in welding simulations and showed promising results. Firstly, \citet{desmaison_level_2014} .... .Later, \citet{chen_three_2014} applied to gas metal arc welding (GMAW) to predict 
