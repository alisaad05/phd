...
spanning on larger distances cannot be treated after solidification. Failure to prevent macrosegregation may lead to a substantial decline in the 
alloy's mechanical behavior, hence its serviceability.
%--------------------------------------------------------
\subsection{Causes}
