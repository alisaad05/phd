...
\end{align}
\end{subequations}
In the presence of gravity, the density gradient causes thermosolutal convection redistributing solutes in the liquid bulk.
 
\subsubsection*{Solidification shrinkage}
Solid alloys have a greater density than the liquid phase ($\rhos > \rhol$), thus occupy less volume. Upon solidification, the liquid moves towards the solidification front 
to compensate for the volume difference. Shrinkage flow can occur even without gravity.
...
Compression and bulging are common in continuous casting ....
