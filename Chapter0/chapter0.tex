...
\Cref{fig:dendritic_growth} shows both columnar and equiaxed morphologies. Columnar dendrites are characterized by a primary spacing, 
...
%
\subsection{Liquid dynamics}
During solidification, the liquid density undergoes changes due to temperature gradients.
In general, an increasing temperature results in a lighter liquid phase and vice-versa.
...
Similarly to thermal gradients, a solute gradient is behind liquid density variations.
...
for others the opposite phenomenon is promoted due to a heavier solute.
%--------------
%\begin{subequations}
%\begin{align}
%\label{eq:rholiq}
