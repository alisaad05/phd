...
$\Tref$ and $\wilref$. However, in a full equilibrium situation, it is possible, even preferred, to work with real density values instead of a linear fit, by using a suitable thermodynamic database. Such possibility will be discussed later in the manuscript (cf. SECTION TODO ) %TODO 
