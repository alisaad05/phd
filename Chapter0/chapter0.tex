...
when the heterogeneity spans some few hundred microns, whereas the term \emph{macrosegregation} refers to a much coraser length scale, ranging
...
In casting processes, such as continuous casting (\cref{fig:cc_process}) and ingot casting, it is crucial to apprehend 
...
study of melt solidification in spray forming and atomization processing
\end{itemize}
