...
ax8.set_xlabel(r'Temperature ($^\circ$C)')
...
# plt.show()
plt.savefig('Tabulation_wCr_MaxMax.png', dpi=300, bbox_inches='tight')
plt.savefig('Tabulation_wCr_MaxMax.pdf', bbox_inches='tight')