...
ax1.set_ylabel(r'$\langle w_{C}^{\phi} \rangle^{\phi}$'+r' [wt.$\%$ $C$]')
...
# plt.show()
plt.savefig('Tabulation_wC_MinMin.png', dpi=300, bbox_inches='tight')
plt.savefig('Tabulation_wC_MinMin.pdf', bbox_inches='tight')