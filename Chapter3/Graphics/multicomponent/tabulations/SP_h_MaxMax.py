...
ax14.set_xlabel(r'Temperature ($^\circ$C)')
...
# plt.show()
plt.savefig('Tabulation_h_MaxMax.png', dpi=300, bbox_inches='tight')
plt.savefig('Tabulation_h_MaxMax.pdf', bbox_inches='tight')