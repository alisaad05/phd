...
solute mixing in the melt). As shown in \textbf{Figure} 8 at 600 s, the first solid phase to form 
...
observations correspond to a simulation time of \num{2000} s in \textbf{Figure} 8. Solidification ends at 
...
composition is observed at the top, is verified in \textbf{Figure} 9a which shows the composition map in a 2D 
vertical slice through the longitudinal axis of the cylinder. We can also see it in \textbf{Figure} 9b where the 
...
that were caused by thermosolutal convection, hence demonstrating the heritage of the solidification process on 
the final distribution of phases. This is better illustrated by drawing the time evolution of the fraction of 
