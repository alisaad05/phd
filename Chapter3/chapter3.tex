...
instabilities are discussed hereinafter. In the present 3D CAFE simulation, each grain shown in \cref{fig:composition_grains} 
...
few degrees here, but this is sufficient to create irregularities on the growth front, as seen on the grain structure in \cref{fig:composition_grains}. 
...
(b) continuous plume, (c) upcoming instability of the plume.} 
