...
enthalpy $H^{\brentzero}$ with the \emph{T2H} conversion. Using an appropriate non-linear algorithm (Brent is the most versatile 
...
system increases instead of steadily decreasing. 
