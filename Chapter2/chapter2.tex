...
%----------------------
\begin{align}
& \textbf{transient term} \quad  \Mij^E = \integral{\OhmE}{\frac{1}{\dt} \interp_i \interp_j }{V} \\ 
& \textbf{advection term} \quad  \Aij^E = \integral{\OhmE}{\rhol \cpl \interp_i \vit \cdot \nabvec \interp_j}{V} \\ 
& \textbf{diffusion term} \quad  \Kija^E = \integral{\OhmE}{\avg{\kappa} \nabvec \interp_i\nabvec \interp_j}{V} \\ 
& \textbf{boundary condition terms}  \quad  \Kijb^E = \integral{\dOhmE}{\hext \interp_i \interp_j}{S} \\ 
& \textbf{boundary condition terms}	 \quad	\Fi^E = \integral{\dOhmE}{\hext \Text \interp_i}{S} \\
& \textbf{source term} \quad  \Si^E = \integral{\OhmE}{\interp_i \source}{V}
\end{align}
%------------
%
...
& \brac{R_i}^t = \Mij \brac{\Hjt - \Hjtminus} + \Aij \Tjt + \brac{\Kija + \Kijb}-\Fi - \Si=0 \\
...
%-----------------
\begin{align}
\label{eq:residual_Hsolver}
%& \brac{R_i}^\iter = \brac{R_i}^\iterminus + \dRdH^\iterminus_{ij}
\end{align}
%------------
Neglecting the second order terms, the suggested correction at each iteration in view of cancelling 
the residual and giving the new value 
%
%
%
%==================
