...
\emph{Remesh2} is an explicit method to compute an anisotropic metric around the zero surface of a distance function, which defines the boundary between two domains.
...
Detailed information can be found in \citep{coupez_metric_2011,el_jannoun_space-time_2014}
