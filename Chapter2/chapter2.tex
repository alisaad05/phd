...
& \temp{\gl \rhol} + \nabvec \cdot \brac{\gl \rhol \vl} =
  \integral{\Gamma_{\liqsol}}{\rhol \vstar \cdot \vec{n}}{A} + \integral{\Gamma_{\liqsol}}{\rhol \vlstar \cdot \vec{n}}{A} 
 S_V \langle  \rangle^* - S_V \langle \rhol \vstar \cdot \vec{n} \rangle^* \\
\label{eq:mass_solid}
