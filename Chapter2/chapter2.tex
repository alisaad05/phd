...
& \tempup{\avg{\psi}} + \nabvec \cdot \avg{\psi \vec{v}} + \nabvec \cdot \avg{\vec{j_{\psi}}} = \avg{Q_{\psi}}
\end{align}
%-------
...
and momentum, all summarised in \cref{tab:conservationeqs}. The latter equation is averaged only for the liquid phase,
