...
composition step is 0.04 wt.\% for carbon and 0.6 wt.\% for chromium, thus representing 2\% 
...
M7C3$\equiv$carbide, CEM$\equiv$cementite), the enthalpy $h^\phi$ and density $\rho^\phi$, are tabulated 
