...
# IMPORT
data1 = np.genfromtxt('capteursTP/Capteur1.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","FractionLiq","FractionBCC","FractionFCC","FractionM7C3","FractionCementite") )
# data2 = np.genfromtxt('capteursTP/Capteur2.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","FractionLiq","FractionBCC","FractionFCC","FractionM7C3","FractionCementite") )
# data3 = np.genfromtxt('capteursTP/Capteur3.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","FractionLiq","FractionBCC","FractionFCC","FractionM7C3","FractionCementite") )
data4 = np.genfromtxt('capteursTP/Capteur4.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","FractionLiq","FractionBCC","FractionFCC","FractionM7C3","FractionCementite") )
# data5 = np.genfromtxt('capteursTP/Capteur5.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
# data6 = np.genfromtxt('capteursTP/Capteur6.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
# data7 = np.genfromtxt('capteursTP/Capteur7.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
# data8 = np.genfromtxt('capteursTP/Capteur8.txt', delimiter=None, skip_header=0, skip_footer=0, names=True , usecols=("Temps","TemperatureC") )
...
ax1.legend([Liquid, BCC, FCC, CARB, CEM, pos1,pos4],['LIQ', 'BCC', 'FCC', '$M_7C_3$', 'CEM','Bottom', 'Top'],loc='right', fancybox=True, shadow=True)

# plt.show()
plt.savefig('TP_no_macro.png', dpi=300, bbox_inches='tight')
plt.savefig('TP_no_macro.pdf', bbox_inches='tight')