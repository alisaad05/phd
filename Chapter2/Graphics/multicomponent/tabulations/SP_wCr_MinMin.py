...
ax2.set_ylabel(r'$\langle w_{Cr}^{\phi} \rangle^{\phi}$'+r'[wt.$\%$ $Cr$]')
...
# plt.show()
plt.savefig('Tabulation_wCr_MinMin.png', dpi=300, bbox_inches='tight')
plt.savefig('Tabulation_wCr_MinMin.pdf', bbox_inches='tight')