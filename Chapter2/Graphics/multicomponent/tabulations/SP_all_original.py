...
# >>>>>>>> ax12
ax12.set_title(r'$\langle w_0 \rangle$='+repr(max_solute1)+'wt%C  '+repr(max_solute2)+'wt%Cr')
ax12.set_ylabel(r'$g^{\phi}$'+'[-]')
...
ax1.set_ylabel(r'$\langle w_{C}^{\phi} \rangle^{\phi}$'+' [wt% C]')
...
ax2.set_ylabel(r'$\langle w_{Cr}^{\phi} \rangle^{\phi}$'+' [wt% Cr]')
...
# >>>>>>>> ax7
ax7.set_title(r'$\langle w_0 \rangle$='+repr(max_solute1)+'wt%C  '+repr(max_solute2)+'wt%Cr')
...
# >>>>>>>> ax8
ax8.set_title(r'$\langle w_0 \rangle$='+repr(max_solute1)+'wt%C  '+repr(max_solute2)+'wt%Cr')
ax8.set_ylabel(r'$\langle w_{Cr}^{\phi} \rangle^{\phi}$'+' [wt% Cr]')
...
# >>>>>>>> ax14
ax14.set_title(r'$\langle w_0 \rangle$='+repr(max_solute1)+' wt%C  '+repr(max_solute2)+'wt%Cr')
ax14.set_ylabel(r'$\langle h^{\phi} \rangle^{\phi}$'+' [J/Kg]')
...
fig.legend([handle for i,handle in enumerate(handles) if i in display]+[LIQ_art, BCC_art, FCC_art, M7C3_art, CEM_art],
         [label for i,label in enumerate(labels) if i in display]+['LIQ', 'BCC','FCC',  'M7C3', 'CEM'],loc='upper right', shadow=True) #center left
...
plt.savefig('SP_macroseg.pdf', dpi=300, bbox_inches='tight')