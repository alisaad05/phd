...
\newcommand\vits{\ensuremath{\avg{\vec{v^s}}}}  
\newcommand\vitf{\ensuremath{\avg{\vec{v^F}}}}  
\newcommand\vita{\ensuremath{\avg{\vec{v^A}}}}
...
\newcommand\wis{\ensuremath{\avg{w_i}^s}}
...
\newcommand\rhoaref{\ensuremath{\rho_{0}^{a}}}
...
\newcommand\vf{\ensuremath{\vec{\avg{v^F}}}}
\newcommand\va{\ensuremath{\vec{\avg{v}^a}}}
\newcommand\vl{\ensuremath{\vec{\avg{v}^l}}}
\newcommand\vs{\ensuremath{\vec{\avg{v}^s}}}
...
\newcommand\Ttop{\ensuremath{T_{top}}}
\newcommand\Tbottom{\ensuremath{T_{bottom}}}
...
MAC		&	Marker-and-cell 				\\
MD		&	Monolithic with low species diffusion in the air \\
MDA		&	Monolithic with low species diffusion and advection in the air \\
NM		&	Non monolithic \\
%MIN	&	Mini-element 					\\
PF		&	Phase field 					\\
