...
line width=\lwidth, mark size=\msize,   dashed, every mark/.append style={solid, fill=gray}, mark=square*\\%
line width=\lwidth, mark size=\msize,   solid, every mark/.append style={solid, fill=gray}, mark=square*\\%
line width=\lwidth, mark size=\msize,   dashed, every mark/.append style={solid, fill=gray}, mark=triangle*\\%
line width=\lwidth, mark size=\msize,   solid, every mark/.append style={solid, fill=gray}, mark=triangle*\\%
line width=\lwidth, mark size=\msize,   dashed, every mark/.append style={solid, fill=gray}, mark=diamond*\\%
line width=\lwidth, mark size=\msize,   solid, every mark/.append style={solid, fill=gray}, mark=diamond*\\%
}
